...
let rec pretty_print_autodifftype = function
  | Middle.UnsizedType.DataOnly -> "data "
  | Middle.UnsizedType.AutoDiffable -> ""

and pretty_print_unsizedtype = function
  | Middle.UnsizedType.UInt -> "int"
  | Middle.UnsizedType.UReal -> "real"
  | Middle.UnsizedType.UVector -> "vector"
  | Middle.UnsizedType.URowVector -> "row_vector"
  | Middle.UnsizedType.UMatrix -> "matrix"
  | Middle.UnsizedType.UArray ut ->
  ...
  | Middle.UnsizedType.UMathLibraryFunction -> "Stan Math function"
...
and pretty_print_sizedtype = function
  | Middle.SizedType.SInt -> "int"
  | Middle.SizedType.SReal -> "real"
  | Middle.SizedType.SVector e -> "vector[" ^ pretty_print_expression e ^ "]"
  | Middle.SizedType.SRowVector e -> "row_vector[" ^ pretty_print_expression e ^ "]"
...
and pretty_print_transformed_type st trans =
  let unsizedtype_string, sizes_string =
    match st with
    | Middle.SizedType.SInt -> (pretty_print_unsizedtype UInt, "")
